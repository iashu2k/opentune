...
class TestValidExtraction:
  ...
  def test_gold_trailing_latex_newline(self):
    assert score("ANSWER: 4.9", "4.9\\n").correct

  def test_space_after_currency_symbol(self):
    assert score("ANSWER: $40444920", "$ 40444920\\n").correct

  def test_scientific_notation(self):
    assert score("ANSWER: 1e-05", "1e-05").correct
...
class TestScoring:
  ...
  def test_large_number_relative_tolerance_outside(self):
    # diff 2000 > 1000
    assert not score("ANSWER: 1,002,000", "1000000").correct
